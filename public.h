...
//#ifdef ST_SSL
extern int st_netfd_ssl_init(st_netfd_t fd);
//#endif
extern void st_netfd_free(st_netfd_t fd);
extern int st_netfd_close(st_netfd_t fd);
extern int st_netfd_close_keep_osfd(st_netfd_t fd);
...
extern int st_connect(st_netfd_t fd, const struct sockaddr *addr, int addrlen,
		      st_utime_t timeout);
//#ifdef ST_SSL
extern int st_connect_ssl(st_netfd_t fd, const struct sockaddr *addr, int addrlen,
		      st_utime_t timeout);
//#endif
